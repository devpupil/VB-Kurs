Public NotInheritable Class SplashStart
    ...
    Private Sub SplashStart_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub tim_splash_Tick(sender As Object, e As EventArgs) Handles tim_splash.Tick
        Me.Close()
    End Sub
End Class
