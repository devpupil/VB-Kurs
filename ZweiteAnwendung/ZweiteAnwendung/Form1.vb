Public Class Form1
    ...
    Private Sub Tbl_adressenBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
    ...
    Private Sub Tbl_adressenBindingNavigatorSaveItem_Click_1(sender As Object, e As EventArgs) Handles Tbl_adressenBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Tbl_adressenBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.AdressenDataSet)
